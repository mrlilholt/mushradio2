...
const chillPlaylist = [
  { title: "new vibes feb28", url: "https://res.cloudinary.com/dtvecsd0q/video/upload/v1740790674/1_Hour_Lofi_Cat_Relax_with_my_cat_-_Sleep_Relax_Study_Chill_4_qqgaut.mp3" },
  { title: "new vibes feb28", url: "https://res.cloudinary.com/dtvecsd0q/video/upload/v1740790841/1_hour_of_aesthetic_calm_lofi_music_chill_4_p5mjqn.mp3" },
...
/>
      ...
      <div className="frosted-glass flex items-center space-x-4 p-4 rounded-lg shadow-md">
